    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        >
          ...
          <el-form-item label="dependProp">
            <el-input
              v-model="activeData.dependProp"
              placeholder="请输入dependProp"
            />
          </el-form-item>
          <el-form-item label="dependVal">
            <el-input
              v-model="activeData.dependVal"
              placeholder="请输入dependVal"
            />
          </el-form-item>
          <el-form-item label="requireProp">
            <el-input
              v-model="activeData.requireProp"
              placeholder="请输入requireProp"
            />
          </el-form-item>
          <el-form-item label="requireVal">
            <el-input
              v-model="activeData.requireVal"
              placeholder="请输入requireVal"
            />
          </el-form-item>
          <el-form-item
          ...
          <el-form-item label="地址">
            <el-input v-model="activeData.url" placeholder="请输入地址" />
          </el-form-item>
          ...
          <el-form-item label="参数">
            <div
              v-for="(item, index) in activeData.params"
              :key="index"
              class="reg-item"
            >
              <span
                class="close-btn"
                @click="activeData.params.splice(index, 1)"
              >
                <i class="el-icon-close" />
              </span>
